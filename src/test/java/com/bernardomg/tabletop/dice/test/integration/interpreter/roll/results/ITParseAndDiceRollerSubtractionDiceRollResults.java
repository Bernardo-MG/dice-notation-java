...
@DisplayName("DiceRoller returns the expected roll results for subtraction operations")
public final class ITParseAndDiceRollerSubtractionDiceRollResults {

    public ITParseAndDiceRollerSubtractionDiceRollResults() {
        super();
    }
