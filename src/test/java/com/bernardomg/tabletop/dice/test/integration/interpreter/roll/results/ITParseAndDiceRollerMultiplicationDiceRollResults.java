...
@DisplayName("DiceRoller returns the expected roll results for multiplication operations")
public final class ITParseAndDiceRollerMultiplicationDiceRollResults {

    /**
     * Default constructor.
     */
    public ITParseAndDiceRollerMultiplicationDiceRollResults() {
        super();
    }
