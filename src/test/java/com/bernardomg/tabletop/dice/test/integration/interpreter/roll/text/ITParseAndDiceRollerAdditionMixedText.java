...
@DisplayName("DiceRoller returns the expected text representation for mixed addition operations")
public final class ITParseAndDiceRollerAdditionMixedText {

    public ITParseAndDiceRollerAdditionMixedText() {
        super();
    }
