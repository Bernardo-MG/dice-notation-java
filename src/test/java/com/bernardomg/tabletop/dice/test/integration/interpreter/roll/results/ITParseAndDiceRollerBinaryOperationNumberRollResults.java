...
@DisplayName("DiceRoller returns the expected roll results for mixed binary operations using only numbers")
public final class ITParseAndDiceRollerBinaryOperationNumberRollResults {

    /**
     * Default constructor.
     */
    public ITParseAndDiceRollerBinaryOperationNumberRollResults() {
        super();
    }
