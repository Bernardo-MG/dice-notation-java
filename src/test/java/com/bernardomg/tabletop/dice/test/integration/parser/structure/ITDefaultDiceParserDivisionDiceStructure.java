...
@DisplayName("DefaultDiceParser parses the expected structure for divisions")
public final class ITDefaultDiceParserDivisionDiceStructure {

    /**
     * Default constructor.
     */
    public ITDefaultDiceParserDivisionDiceStructure() {
        super();
    }
