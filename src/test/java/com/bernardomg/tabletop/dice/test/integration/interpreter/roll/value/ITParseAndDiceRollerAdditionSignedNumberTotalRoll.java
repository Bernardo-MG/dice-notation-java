...
@DisplayName("DiceRoller returns the expected total roll for addition operations using only numbers, including signed numbers")
public final class ITParseAndDiceRollerAdditionSignedNumberTotalRoll {

    /**
     * Default constructor.
     */
    public ITParseAndDiceRollerAdditionSignedNumberTotalRoll() {
        super();
    }
