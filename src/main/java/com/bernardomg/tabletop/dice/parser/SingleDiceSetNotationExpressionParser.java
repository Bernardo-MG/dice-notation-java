 ...
 */
public final class SingleDiceSetNotationExpressionParser implements
        DiceNotationExpressionParser<RollableDiceNotationExpression> {
    ...
    @Override
    public final RollableDiceNotationExpression parse(final String expression) {
