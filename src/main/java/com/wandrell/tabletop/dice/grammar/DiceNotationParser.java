...
public class DiceNotationParser extends Parser {
    ...
    public static class NotationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterNotation(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitNotation(this);
        }
    }
    ...
    public static class ExpressionContext extends ParserRuleContext {
        ...
        public TerminalNode OPERATOR_DIV() {
            return getToken(DiceNotationParser.OPERATOR_DIV, 0);
        }
        ...
        public TerminalNode FUNCTION() {
            return getToken(DiceNotationParser.FUNCTION, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitExpression(this);
        }
    }
    ...
    public static class OperandContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterOperand(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitOperand(this);
        }
    }
    ...
    public static class OperationParenthesisContext extends ParserRuleContext {
        public TerminalNode LPAREN() {
            return getToken(DiceNotationParser.LPAREN, 0);
        }
        ...
        public TerminalNode RPAREN() {
            return getToken(DiceNotationParser.RPAREN, 0);
        }

        public TerminalNode GROUP_MODIFIER() {
            return getToken(DiceNotationParser.GROUP_MODIFIER, 0);
        }
    ...
    public static class DiceContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterDice(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitDice(this);
        }
    }
    ...
    public static class IntegerDiceContext extends ParserRuleContext {
        public TerminalNode DiceHeader() {
            return getToken(DiceNotationParser.DiceHeader, 0);
        }
    ...
    public static class PercentileDiceContext extends ParserRuleContext {
        ...
        public TerminalNode PERCENTILE() {
            return getToken(DiceNotationParser.PERCENTILE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterPercentileDice(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitPercentileDice(this);
        }
    }
    ...
    public static class FudgeDiceContext extends ParserRuleContext {
        ...
        public TerminalNode FUDGE() {
            return getToken(DiceNotationParser.FUDGE, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).enterFudgeDice(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof DiceNotationListener)
                ((DiceNotationListener) listener).exitFudgeDice(this);
        }
    }
