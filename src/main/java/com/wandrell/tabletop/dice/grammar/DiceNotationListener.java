...
public interface DiceNotationListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DiceNotationParser#operationParenthesis}.
	 * @param ctx the parse tree
	 */
	void enterOperationParenthesis(DiceNotationParser.OperationParenthesisContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiceNotationParser#operationParenthesis}.
	 * @param ctx the parse tree
	 */
	void exitOperationParenthesis(DiceNotationParser.OperationParenthesisContext ctx);
	/**
